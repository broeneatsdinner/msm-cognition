...
Active filters: locked templates allowed, Paironormal templates excluded, minimum size `112x112`, match threshold `0.700`.

Active templates: `enhanced-breeding-structure.webp, locked-breeding-structure.webp, normal-breeding-structure.webp`
