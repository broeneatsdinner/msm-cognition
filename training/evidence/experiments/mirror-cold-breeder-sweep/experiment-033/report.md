...
Active filters: locked templates excluded, Paironormal templates excluded, minimum size `96x96`, match threshold `0.720`.
...
| 2 | enhanced-breeding-structure.webp | 0.726 | low | 0.15 | `x=1830, y=310, w=132, h=132` |
...
![Candidate 2 Breeding Structure crop](candidate-2-crop-breeder.png)

Upscaled evidence crop:

![Candidate 2 Breeding Structure crop 4x](candidate-2-crop-breeder-4x.png)

## Manual parent recognition

Manual parent recognition comes only from `--parents LEFT RIGHT` and currently applies to candidate 1 only.

Left manual parent: **not supplied**  
Right manual parent: **not supplied**
...
![Candidate 2 left parent egg crop](candidate-2-crop-left-parent-egg.png)

Upscaled evidence crop:

![Candidate 2 left parent egg crop 4x](candidate-2-crop-left-parent-egg-4x.png)

Manual parent: **not supplied**  
...
| Rank | Monster | Score | RMS | Reference |
|---:|---|---:|---:|---|
| 1 | Oaktopus | 87.1 | 56.99 | ![Oaktopus](candidate-2-reference-left-match-1-oaktopus.webp) |
| 2 | Pango | 86.7 | 58.76 | ![Pango](candidate-2-reference-left-match-2-pango.webp) |
| 3 | Noggin | 86.1 | 61.53 | ![Noggin](candidate-2-reference-left-match-3-noggin.webp) |
| 4 | Shrubb | 85.5 | 63.85 | ![Shrubb](candidate-2-reference-left-match-4-shrubb.webp) |
| 5 | T-Rox | 85.5 | 64.23 | ![T-Rox](candidate-2-reference-left-match-5-t-rox.webp) |
...
![Candidate 2 right parent egg crop](candidate-2-crop-right-parent-egg.png)

Upscaled evidence crop:

![Candidate 2 right parent egg crop 4x](candidate-2-crop-right-parent-egg-4x.png)
...
| Rank | Monster | Score | RMS | Reference |
|---:|---|---:|---:|---|
| 1 | Pango | 89.4 | 46.80 | ![Pango](candidate-2-reference-right-match-1-pango.webp) |
| 2 | Oaktopus | 89.3 | 47.11 | ![Oaktopus](candidate-2-reference-right-match-2-oaktopus.webp) |
| 3 | Noggin | 88.1 | 52.54 | ![Noggin](candidate-2-reference-right-match-3-noggin.webp) |
| 4 | Cybop | 87.4 | 55.43 | ![Cybop](candidate-2-reference-right-match-4-cybop.webp) |
| 5 | Shrubb | 87.4 | 55.47 | ![Shrubb](candidate-2-reference-right-match-5-shrubb.webp) |
...
Island: Mirror Cold Island
Alias: Mirror Cold Island -> Cold Island
Parents used: Oaktopus + Pango
Left parent source: automated_egg_reference_match
Right parent source: automated_egg_reference_match
```

## Final guess

Likely result: **no match in current breeding data**

Confidence: **manual_review**

Reason:

- The parent pair was recognized, but no island-scoped result matched the current structured breeding data.
- This may mean the data is incomplete, the crop was misread, or the monster is outside the current data scope.
...
| Raw template | Color | Edge | Shape/mask | Local context | Negative penalty | Layout sanity | Breeder-likeness | Best reference |
|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0.726 | 0.107 | 0.238 | 0.202 | 0.447 | 0.800 | 1.000 | **0.000** | normal-breeding-structure.webp @ 1.15x |

Context box: `x=1665, y=145, w=462, h=462`

![Candidate 2 source context](candidate-2-source-context.png)

![Candidate 2 source context with detector box](candidate-2-source-context-boxed.png)
